...
//Variabili globali per il numero vincente, i tentativi massimi e il settaggio dei record
var lucky_number = 0;
var max_tries = 0;
...
function newGame() {
    ...
    //document.getElementById("hint").innerHTML=lucky_number; //Solo per i test, poi va tolta
}
        ...
        if (number >= 0 && number <= 100) { //se il numero è compreso tra 0 e 100 il gioco può iniziare;
            ...
            switch (true) {
                case number == lucky_number:
                    ...
                    {
                                                    document.getElementById("record_screen").setAttribute("hidden","");                                 
                    }
